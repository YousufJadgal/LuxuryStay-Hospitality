            ...
            <div className="container">
                ...
                <div className="row mb_30">
                    <div className="col-lg-3 col-sm-6">
                        <div className="accomodation_item text-center">
                            <div className="hotel_img">
                                <img src="template/image/room1.jpg" alt=""/>
                    ...
                    <div className="col-lg-3 col-sm-6">
                        <div className="accomodation_item text-center">
                            <div className="hotel_img">
                                <img src="template/image/room2.jpg" alt=""/>
                                <a href="#" className="btn theme_btn button_hover">Book Now</a>
                            </div>
                    ...
                    <div className="col-lg-3 col-sm-6">
                        <div className="accomodation_item text-center">
                            <div className="hotel_img">
                                <img src="template/image/room3.jpg" alt=""/>
                                <a href="#" className="btn theme_btn button_hover">Book Now</a>
                            </div>
                    ...
                    <div className="col-lg-3 col-sm-6">
                        <div className="accomodation_item text-center">
                            <div className="hotel_img">
                                <img src="template/image/room4.jpg" alt=""/>
                                <a href="#" className="btn theme_btn button_hover">Book Now</a>
                            </div>
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-md-6">
                        <img className="img-fluid" src="template/image/about_bg.jpg" alt="img" />
                    </div>
                </div>
            </div>
        </section>
            ...
            <div className="container">
                ...
                <div className="testimonial_slider owl-carousel">
                    <div className="media testimonial_item">
                        <img className="rounded-circle" src="template/image/testtimonial-1.jpg" alt=""/>
                ...
                <div className="row mb_30">
                    <div className="col-lg-4 col-md-6">
                        <div className="single-recent-blog-post">
                            <div className="thumb">
                                <img className="img-fluid" src="template/image/blog/blog-1.jpg" alt="post"/>
                            </div>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="single-recent-blog-post">
                            <div className="thumb">
                                <img className="img-fluid" src="template/image/blog/blog-2.jpg" alt="post"/>
                            </div>
                            <div className="details">
                                <div className="tags">
                                    <a href="#" className="button_hover tag_btn">Travel</a>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="single-recent-blog-post">
                            <div className="thumb">
                                <img className="img-fluid" src="template/image/blog/blog-3.jpg" alt="post"/>
                            </div>
                            <div className="details">
                                <div className="tags">
                                    <a href="#" className="button_hover tag_btn">Travel</a>
